...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/main/bootstrap.css" />
  ...
  <!-- font awesome style -->
  <link href="${pageContext.request.contextPath}/css/main/font-awesome.min.css" rel="stylesheet" />

  <!-- Custom styles for this template -->
  <link href="${pageContext.request.contextPath}/css/main/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="${pageContext.request.contextPath}/css/main/responsive.css" rel="stylesheet" />
